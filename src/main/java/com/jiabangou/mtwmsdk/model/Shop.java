...
public class Shop implements Serializable{
    ...
    private Double latitude; //	float	是	38.693203	门店纬度 （美团使用的是高德坐标系，也就是火星坐标系，如果是百度坐标系需要转换）(门店坐标不需要乘以一百万)
    private Double longitude; //	float	是	115.281708	门店经度 （美团使用的是高德坐标系，也就是火星坐标系，如果是百度坐标系需要转换）(门店坐标不需要乘以一百万)
